    ...
    <div className="flex-1 bg-white">
      <div className="p-7">
        ...
        <div className="flex mt-2 mb-2 overflow-x-auto p-2" style={{ scrollBehavior: 'smooth', background: 'transparent' }}>
          <div key={'All'} className="mr-4 mb-4 min-w-20">
            <button
              ...
              className={`px-4 py-2 text-white text-lg rounded-lg font-bold hover:bg-honey w-32 ${
                selectedCategory === 'All' ? 'bg-main-honey' : 'bg-light-green'
              }`}
            >
              All
            </button>
          ...
          {categories.map((category, index) => (
            <div key={index} className="mr-4 mb-4 min-w-20">
              <button
        ...
        {filteredProducts.length > 0 ? (
              ...
              <div key={index} className="relative">
                ...
                <div className="rounded-md bg-gray-100 border border-gray-100 h-[98%] p-4 mb-4 shadow-bottom order-slip-bg cursor-pointer">
                  ...
                  <div onClick={() => showProductDetails(product)}>
                    ...
                    </p> <p className="font-semibold mt-2 text-center">
                      {" "}
                    <span
                      className={`${
          ...
          <p className='text-center text-red-700 font-bold'>No products available</p>
        )}
          ...
          <div className="fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50">
            <div className="bg-gray-100 p-8 rounded-lg overflow-y-auto" style={{ width: '70%', height: '80%' }}>
              <div className="flex justify-between m-4">
                <h2 className="text-3xl font-extrabold mt-10 mx-6 text-white bg-main-green p-2 mb-2 rounded-lg">
                  {selectedProduct.Name}
                </h2>
                <div>
                  {editMode ? (
                    <button
                    className="bg-main-honey text-white px-3 py-1 rounded-md mr-2"
              ...
              <div className="mt-4 flex justify-between m-10">
                ...
                <div className="w-2/3 mx-10">
                  ...
                  <div>
                    ...
                    <p className="font-semibold mt-2 border border-gray-100 rounded-md p-2 bg-white">
                    ...
                    {editMode && (
                    <button onClick={handleUpdateProductDes} className="mt-4 p-2 bg-green-700 text-white rounded-md">Submit Changes</button>
                    )}
                  </div>
                  <div className="mt-10">
                    <button
                      className={`bg-main-green text-white px-3 py-1 rounded-md mr-2 ${
                        selectedTemperature === 'hot' ? 'bg-green-700' : ''
                      }`}
                    ...
                    <button
                      className={`bg-main-green text-white px-3 py-1 rounded-md ${
                        selectedTemperature === 'iced' ? 'bg-green-700' : ''
                      }`}
                  ...
                  <div className="mt-10">
                    ...
                    {editMode && !showAddForm && (
                      <button className="mt-10 text-white bg-main-honey px-3 py-2 rounded-md" onClick={handleAddFormToggle}>Add Size</button>
                    )}
                    {editMode && showAddForm && (
                  ...
                  {editMode && (
                    <div className="mt-10 mx-10">
                      ...
                      />
                      <button
                        className="mt-4 text-white bg-green-700 px-4 py-2 rounded-md"
